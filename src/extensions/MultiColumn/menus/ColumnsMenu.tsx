...
import { getRenderContainer } from '@/src/lib/utils/getRenderContainer'
import { Toolbar } from '@/src/components/ui/Toolbar'
import { ColumnLayout } from '../Columns'
import { Icon } from '@/src/components/ui/Icon'

export const ColumnsMenu = ({ editor, appendTo, lang }: MenuProps | any) => {
  ...
  return (
    ...
    >
      <Toolbar.Wrapper>
        <Toolbar.Button
          tooltip={lang.extension.MultiColumn.ColumnMenu.tooltip.sidebarLeft}
        ...
        <Toolbar.Button
          tooltip={lang.extension.MultiColumn.ColumnMenu.tooltip.twoColumns}
