  ...
  return (
    ...
    >
      <Toolbar.Wrapper shouldShowContent={shouldShow()} ref={menuRef}>
        <Toolbar.Button
          tooltip={lang.extension.ImageBlock.tooltip.alignImageLeft}
        ...
        <Toolbar.Button
          tooltip={lang.extension.ImageBlock.tooltip.alignImageCenter}
        ...
        <Toolbar.Button
          tooltip={lang.extension.ImageBlock.tooltip.alignImageRight}
        ...
        <Toolbar.Divider />
        <ImageAltMenu onChange={onAltChange} value={editor.getAttributes('imageBlock').alt}/>
      </Toolbar.Wrapper>
    </BaseBubbleMenu>
  )
}
