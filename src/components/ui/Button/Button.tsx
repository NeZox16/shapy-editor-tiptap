...
export type ButtonVariant = 'primary' | 'secondary' | 'tertiary' | 'quaternary' | 'ghost' | 'gs'
...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const buttonClassName = cn(
      ...
      variant === 'gs' &&
        cn('bg-gs-green/40 border-transparent  text-gs-green transition-all hover:bg-gs-green/50', 
        /* !disabled && !active && 'hover:opacity-60 hover:text-gs-green/60 active:opacity-70 active:text-gs-green/70' */ activeClassname),
